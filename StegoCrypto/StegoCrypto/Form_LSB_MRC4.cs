...
namespace StegoCrypto
{
    public partial class Form_LSB_MRC4 : Form
    {
        ...
        private void Button_Encode_Click(object sender, EventArgs e)
        {
            ...
            timer.Start();
            Controller_LSB LSB = new Controller_LSB(C_Image, Key.Text, Plaintext.Text, Setting);
            S_Image = LSB.Encode(Ciphertext, Stego_Image, Button_Save);
            timer.Stop();
        ...
        private void Button_Decode_Click(object sender, EventArgs e)
        {
            ...
            Controller_LSB LSB = new Controller_LSB(S_Image, Key2.Text,NCharacter2.Value, Setting);
            LSB.Decode(Ciphertext2, Plaintext2, Button_Save2);
            timer.Stop();
            Console.WriteLine(timer.Elapsed.ToString());
        }
        ...
        private void Cover_Image_Click(object sender, EventArgs e)
        {
